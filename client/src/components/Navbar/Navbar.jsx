...
function Navbar() {
  return (
    <header className="font-['Inter'] flex justify-between items-center px-6 py-5 border-b border-emerald-100/70 shadow-[0_-4px_16px_rgba(6,78,59,0.7)] rounded-b-2xl bg-white/70 sticky top-0 z-50">
      {/* Logo Area */}
      <Link to="/" className="flex items-center gap-3 rounded-full border border-emerald-200 shadow-sm text-emerald-900 font-semibold tracking-[2.8px] uppercase px-4 py-2 no-underline transition-transform hover:-translate-y-0.5">
