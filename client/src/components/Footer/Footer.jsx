...
function Footer() {
  return (
    <footer className="font-['Inter'] bg-white/70 border-t border-emerald-100/70 pt-4 pb-4 shadow-[0_-4px_16px_rgba(6,78,59,0.7)] rounded-t-2xl z-50">
      <div className="flex flex-wrap justify-between items-center gap-4 w-5/6 mx-auto px-6 text-emerald-900/70 text-sm">
